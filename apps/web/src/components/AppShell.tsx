...
const navItems: Array<{ label: string; to: string; icon: typeof LayoutDashboard; permission: Permission; roles?: string[] }> = [
  ...
  { label: "Récap absences", to: "/absences/recap", icon: CalendarCheck, permission: "reports.read", roles: ["ADMIN", "DRH", "GRH"] },
  ...
  { label: "Accident travail", to: "/work-accidents", icon: CalendarX, permission: "attendance.read", roles: ["ADMIN", "DRH", "GRH"] },
